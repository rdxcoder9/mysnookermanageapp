            ...
            <div class="screen__content">
                <form class="login" action="./process.php" method="POST">
                    ...
                    <div style="display:none;">
                        <input type="text" value="3" name="code">
                    </div>
                ...
                <div class="social-login">
                    <h3>Aman's Capital</h3>
                    <div class="social-icons">
                        <a href="./login.php" class="social-login__icon fab fa-instagram"></a>
                        <a href="./login.php" class="social-login__icon fab fa-facebook"></a>
                        <a href="./login.php" class="social-login__icon fab fa-twitter"></a>
                    </div>
                </div>
            </div>
